...
- `eval-harness rubric [--list] [--show <id>] [--create-name <name> --create-file <path>] [--delete <id>] [--json]` — manage rubric templates
- `eval-harness trend [--rubric <id>] [--judge <model>] [--since <date>] [--json]` — score timeline + regression detection
